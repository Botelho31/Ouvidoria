  ...
  return (
    <PageBody>
      ...
      <Flexbox flexDirection="column" verticalAlign="flex-start" style={{ marginLeft: 20, marginRight: 20 }}>
        ...
        <Margin/>
        <InputDropdown placeholder="Escolha um orgão" label="Qual órgão está relacionado ao ocorrido?" options={complaintTypes}/>
        <Margin/>
        <InputTextArea placeholder="Escreva um titulo" type="" title="Título" check/>
        <Margin/>
        <InputTextArea placeholder="Escreva um texto" type="texto" title="Texto" check/>
        <Margin/>
